...
| 6.9 | Client Script Sandbox Foundation | Hardening (6.9.1) | Migration 0056: erp_client_scripts table, 6 RPCs, 5 permissions, CRM Lead demo. Migration 0057: server-side validate_client_script_body(), hardened RPCs (+ doctype permission check), hardened RLS. Sandbox engine, React hook, DynamicFormPage integration, ClientScriptsPage management UI. Cloud/browser verifiers updated with security checks. Not yet run on cloud. |
