...
| 6.8.3 | Credential Rotation Proof Gate | Complete | Publishable key rotated (`sb_publishable_s1_4--4nxdoY1vInmomjCg_ybbUTu2A`). Service role key and test passwords NOT rotated (old credentials still work). Secret scan clean. Cloud 36/36 PASS, Browser 23/23 PASS with new publishable key. Passwords remain as old values pending manual Dashboard rotation. |
