...
| 2.10 | Custom DocType Wizard Hardening | Complete | Atomic bundle RPC, duplicate checks, permission auto-provisioning (catalog + owner/admin grants), sidebar refresh, success checklist, simulation. |
