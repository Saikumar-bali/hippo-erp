...
// ── Phase 4.3+: Inventory read-only API (current) ───────────────────────────────
...
// ── Legacy re-exports from product-api (required by app imports) ─────────────────
...
// ── Legacy helpers (kept for existing imports, not used by current UI) ───────────
// @deprecated — These helpers reference pre-Phase-4.1 tables/RPCs.
// They are preserved only for backward-compatible imports (e.g. ModuleView, AuthContext).
// Do not import these in new UI components. Use the Phase 4.3+ read-only API above.
...
/** @deprecated — Use wh_list_current_inventory RPC via listCurrentInventory() */
...
/** @deprecated — Use wh_list_inventory_movements RPC via listInventoryMovements() */
...
/** @deprecated — Legacy warehouse CRUD. Use metadata-driven warehouse pages. */
...
/** @deprecated — Legacy GRN creation. Use wh_create_grn_draft RPC via grn-api. */
...
// ── Internal helpers (kept for legacy exports above) ─────────────────────────
